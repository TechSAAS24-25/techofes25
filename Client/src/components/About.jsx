...
const AboutSection = () => {
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center w-full h-full px-6 text-center">
        {/* Text Section */}
        <motion.h1
        ...
        <motion.p
          className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed max-w-4xl mx-auto"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div
          className="absolute bottom-5 text-red-300 text-sm sm:text-base"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
