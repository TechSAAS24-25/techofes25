...
const getTotalUsers = async () => {
  const response = await axios.get(`${adminUrl}/totalusers`, 
    // {
    // headers: {
    //     Authorization: `Bearer ${storage.loadUser().token}`,
    //     },
...
const getEventRegistrations = async (eventId) => {
  const response = await axios.get(`${adminUrl}/registrations/${eventId}`, 
    // {
    // headers: {
    //     Authorization: `Bearer ${storage.loadUser().token}`,
    //     },
...
const getTotalEventRegistrations = async () => {
  const response = await axios.get(`${adminUrl}/totalregistrations`, 
    // {
    // headers: {
    //     Authorization: `Bearer ${storage.loadUser().token}`,
    //     },
