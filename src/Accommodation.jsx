...
function Accommodation() {
    const contents = [
        { content: "Techofes is an annual intercollegiate culture festival at the College of Engineering, Guindy in Chennai, India. The tradition began in 1948. It is a three-day event usually held in mid-February." },
